...
function listar(){
    ...
    tabla = $('#tbllistado').dataTable({
        ...
        "ajax":
                {
                    url: '../ajax/pagoproveedor.ajax.php?op=listar',
                    type: "get",
                    dataType: "json",
                    error: function(e){
...
//FUNCION MOSTRAR
function mostrar(idpagoproveedor){

    $.post("../ajax/pagoproveedor.ajax.php?op=mostrar", {idpagoproveedor:idpagoproveedor}, function(data, status){

        data = JSON.parse(data);
        mostrarform(true);

        $("#idpagoproveedor").val(data.idpagoproveedor);
